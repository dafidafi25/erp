...
export default {
  ...
  actions: {
      ...
      return new Promise((resolve, reject) => {
        axios
          .post("/items", {
            ...
            price_last_sell: price_last_sell,
          })
          .then((res) => {
            resolve(res);
          })
    ...
    ADD_ITEM_GRADE: (
      { commit },
      { nilai, keterangan, active_flag, is_default }
    ) => {
      return new Promise((resolve, reject) => {
        axios
    ...
    UPDATE_ITEM_GRADE: (
      { commit },
      { id, nilai, keterangan, active_flag, is_default }
    ) => {
      return new Promise((resolve, reject) => {
        axios
    ...
    ADD_PRICE_DATA: (
      { commit },
      { item_id, harga_baru, ongkos, disc_persen, disc_price, active_flag }
    ) => {
      return new Promise((resolve, reject) => {
        axios
    ...
    UPDATE_PRICE_DATA: (
      { commit },
      { id, item_id, price_buy, ongkos, disc_persen, disc_price, active_flag }
    ) => {
      return new Promise((resolve, reject) => {
        axios
    ...
    UPDATE_ITEM_TYPE: (
      { commit },
      { id, type_name, merek_id, kategori_id }
    ) => {
      return new Promise((resolve, reject) => {
        axios
